...
**Med2Vec+** is a representation learning model that has the capacity of **EHR codes and Clinical Notes** on **MIMIC-IV**. It reproduces Med2Vec-style representation that is directly exchangeable with Med2Vec while extending Med2Vec with clinical notes via aspect-level attention.  
